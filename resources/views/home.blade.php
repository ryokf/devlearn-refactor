 ...
 background-position: center;">
    <div class="py-20 md:py-36 bg-black/50 md:px-40 px-10 ">
        ...
        <div class="text-center mt-8">
            <a href="{{ route('login') }}" class="w-full px-6 py-3 rounded-full ml-2 text-base font-semibold text-slate-800 align-middle bg-white border border-slate-800 select-none sm:mb-0 sm:w-auto hover:bg-slate-800 hover:text-white focus-within:bg-slate-800 focus-within:border-slate-800">
                Mulai Mengajar
            </a>
        </div>
