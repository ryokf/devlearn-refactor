            ...
            <div class="container mx-auto">
                <div class="sm:flex gap-10 items-center md:justify-center text-white">
                    ...
                    <div class="flex gap-4 items-center md:basis-1/5 md:my-0 my-5">
                        ...
                        <div class="text">
                            <h2 class="font-medium text-xl pb-3 md:pb-0 text-black dark:text-white">Mudah Dipahami</h2>
                        </div>
                    </div>
                    <!-- item end -->
                    <!-- item start -->
                    ...
                    <div class="flex gap-3 items-center md:basis-1/5 md:my-0 my-5">
                        ...
                        <div class="text">
                            <h2 class="font-medium text-xl pb-3 md:pb-0 text-black dark:text-white">Ramah Pengguna</h2>
                        </div>
                    </div>
                    <!-- item end -->
                </div>
