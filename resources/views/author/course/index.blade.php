                    ...
                    <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
                                    ...
                                    <div class="font-semibold text-lg text-blueGray-700">
                                        <form class="md:flex hidden flex-row flex-wrap items-center lg:ml-auto mr-3">
                                            <div class="relative flex w-full flex-wrap items-stretch">
                                              ...
                                              <input type="text" placeholder="Search here..." class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded text-sm outline-none focus:outline-none ring-gray-400 w-full pl-10">
                                            </div>
                                          </form>
                                    </div>
                                    <div class="flex">
                        ...
                        <div class="block w-full overflow-x-auto">
                            ...
                            <table class="items-center w-full bg-transparent border-collapse">
                                ...
                                @foreach ($course as $number => $c) --}}
                                    {{-- <x-author.course_tile --}}
                            ...
                            <div class="w-52 mx-auto h-16 flex">
                                {{-- {{ $courses->currentPage() }} --}}
