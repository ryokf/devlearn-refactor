<x-admin-layout>
            ...
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6">
                        <form action="{{ route('admin.course.category.add') }}" method="post"
                ...
                <tbody>
                    @foreach ($categories as $category)
                        <tr class="">
                            ...
                            <th scope="row"
                                class="border-t-0 px-9 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                <img src="{{ asset('storage/' . $category->photo) }}" class="w-20 h-20" alt="">
                            </th>
                            <th scope="row"
                                class="border-t-0 px-9 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                ...
                                <button class="bg-red-500 p-2 rounded-md text-white hover:bg-red-700 mr-1"
                                    type="button" onclick="openDeleteModal({{ $category->id }})">Delete</button>
                            </th>
                    @endforeach
                    </tr>
                </tbody>
    ...
    <x-delete-validation text="category" url="{{ url('admin/course/category') }}" />
</x-admin-layout>
