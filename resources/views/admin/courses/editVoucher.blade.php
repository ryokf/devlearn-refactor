<x-admin-layout>
    <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white mx-auto">
        <div class="p-5">
            ...
            <form action="{{ route('admin.course.voucher.edit', $course->id) }}" method="POST">
                <div class="mb-6">
                    <label for="courseName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Course
                        Name</label>
                ...
                @if ($course->voucher !== null && $course->voucher->token !== null)
                    <div class="mb-6">
                        <label for="courseVoucher" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Voucher Code
                        </label>
                        <input type="text" id="text" id="disabled-input" aria-label="disabled input" disabled
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
