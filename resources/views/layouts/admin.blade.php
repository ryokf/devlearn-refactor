...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admins/style.css') }}">
...
<body>
        ...
        <section id="NotifMessages">
            <div
                ...
                <div class="flex flex-1 justify-end">
                    <button id="closeNotif" type="button" class="-m-3 p-3 focus-visible:outline-offset-[-4px]">
    ...
    <script>
        ...
        var box = document.getElementById('NotifMessages'); // Ganti 'myBox' dengan ID dari elemen div kotak Anda
        var closeButton = document.getElementById('closeNotif'); // Ganti 'closeButton' dengan ID dari elemen tombol Anda

        // Fungsi untuk menutup kotak
        function closeBox() {
            box.style.display = 'none';
        }

        // Menambahkan event listener pada tombol untuk memanggil fungsi closeBox saat diklik
