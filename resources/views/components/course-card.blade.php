<div>
    <a href="{{ route('course.show', $id) }}">
        <div class="border border-gray-100 shadow-sm rounded transition group-hover:shadow-lg w-full h-96">
            <img src="{{ asset('storage/' . $photo) }}" alt="" class="w-full rounded rounded-b-none w-full h-48 object-cover" />
            <div class="mt-3 p-3">
