        ...
        <div class="relative flex flex-col min-w-0 break-words {{ $iconBgColor }} rounded-xl overflow-hidden mb-6 xl:mb-0">
            <div class="flex-auto pt-4">
                ...
                <div class="relative w-auto pl-4 flex-initial">
                    <div
                    class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 shadow-lg rounded-full bg-white bg-opacity-20 backdrop-blur-lg">
                    <i class="{{ $icon }}"></i>
                </div>
            </div>
        </div>
        <p class="text-sm text-blueGray-400 mt-4 bg-white bg-opacity-40 rounded-b-xl backdrop-blur-lg p-2">
            @if ($arrow)
