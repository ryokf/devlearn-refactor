<tr>
    ...
    <th class="max-w-sm border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs p-4 text-left flex items-center">
    ...
    <td class="px-6 align-left max-w-lg text-xs whitespace-nowrap p-4">
        <div class="inline-flex rounded-md" role="group">
            <div class="bg-amber-500 rounded-l-lg" title="lihat detail kursus">
                <a href="{{ route('author_lesson_edit', ['id' => $id]) }}"
                    class="flex inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-transparent border border-amber-500 rounded-l-lg focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:bg-gray-700">
    ...
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                ...
                <form action="{{ route('author_lesson_delete') }}" method="POST">
                    @csrf
                    @method('delete')
